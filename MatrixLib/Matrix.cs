    ...
    public class Matrix
    {
        ...
        public MatrixResult Solve(out Rational[] results)
        {
            ...
            for (int i = 0; i < rowsForSolving.Count; i++)    //go through all lines from the begining
            {
                ...
                {
                    SimplifyColumnOfMatrix(rowsForSolving, ref i);
        ...
        private void SimplifyColumnOfMatrix(List<MatrixRow> rowsForSolving, ref int rowNumber)
        {
        ...
        private void SwitchRows(List<MatrixRow> rowsForSolving, int rowPosition)
        {
