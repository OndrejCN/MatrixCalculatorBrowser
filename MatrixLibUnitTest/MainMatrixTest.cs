...
namespace MatrixLibUnitTest
{
    ...
    {
        const int CYCLES = 5;                //kolko matic sa ma vygenerovat a overit
        ...
        private List<Rational[]> SolveListOfMatrixes(List<Matrix> matrixList)
        {
        ...
        public void Test_SolveMethodWithListOfRandomMatrixes()
        {
            ...
            List<Rational[]> solvedResults = SolveListOfMatrixes(matrixList);
